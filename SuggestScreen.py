...
# Form implementation generated from reading ui file 'SuggestScreen.ui'
#
...
class Ui_SuggestScreen(object):
    ...
    def retranslateUi(self, SuggestScreen):
        ...
        SuggestScreen.setWindowTitle(_translate("SuggestScreen", "Cypress"))
        ...
        self.description_label.setText(_translate("SuggestScreen", "Suggest solutions to reported problems and assign priority by liking a problem"))
...
if __name__ == "__main__":
    ...
    SuggestScreen = QtWidgets.QMainWindow()
    ui = Ui_SuggestScreen()
    ui.setupUi(SuggestScreen)
    SuggestScreen.show()
    sys.exit(app.exec_())
